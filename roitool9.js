...
console.log('collegeSelect change event handler added.');
collegeSelect.addEventListener('change', function() {
    console.log('Selected college:', this.value);
    if (!sessionStorage.getItem('emailSubmitted')) {
        console.log('No email submitted this session. Showing modal...');
        showModal();
    } else {
        console.log('Email already submitted. Fetching college details...');
        fetchCollegeDetails(this.value);
    }
});
