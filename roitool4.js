...
// Create and insert the modal HTML directly without using template literals or escape sequences that could cause errors.
var modalDiv = document.createElement('div');
modalDiv.id = 'emailModal';
modalDiv.style.display = 'none'; // Start hidden
modalDiv.innerHTML = '<div style="background-color: white; padding: 20px; border-radius: 5px; text-align: center;">' +
                     '<p>To view your results, please enter a valid email address. We will also send you an email with your results. Thank you!</p>' +
                     '<input type="email" id="emailInput" placeholder="Enter your email" style="margin-top: 10px; width: 80%;">' +
                     '<button id="submitEmail" style="margin-top: 10px;">Submit</button>' +
...
var submitEmailButton = document.getElementById('submitEmail');
