document.addEventListener('DOMContentLoaded', function () {
    ...
    function insertEmailAndChoice() {
        const endpointUrl = 'https://us-east-1.aws.data.mongodb-api.com/app/roitoolapp-jnjed/endpoint/insertUserChoice';
        ...
        const insertUserChoiceData = {
            email: window.sessionStorage.getItem("session-email"),
            state: stateSelect.value,
            residency: inStateTuitionField.value,
